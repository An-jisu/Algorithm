...
## 🎁 나의 풀이: <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/8d4fa2dd-391c-4130-8f62-9937b6ba576d) <br>
-> for 문으로 quiz의 문자열들 하나씩 접근하면서, 각 문자열을 분리하고, 그 결괏값가 arr배열 마지막 요소가 같은지 삼항연산자로 검사하여 answer배열에 push 하였다. <br><br>

## ⭕ 다른 사람의 풀이: <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/959bf476-3a4c-4d94-91db-7eebb6766299) <br>
-> 구조분해 할당으로 처리하면, 인덱스로 접근하지 않아도 된다는 것!! <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/57ff5780-fbc0-46f9-af27-a3b638525be6) <<br>
-> =를 기준으로 분리해서 eval의 값과 b값을 비교할 수도 있다는 것!!! <br><br>
