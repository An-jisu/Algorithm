...
## 🎁 나의 풀이: <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/76a1c23c-c265-4ab4-b98b-441db79432f0) <br>
-> 각 가로, 세로, 높이에 해당하는 값들을 n의 값으로 나눈 값들을 곱해서 반환하였다. <br><br>

## ⭕ 다른 사람의 풀이: <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/b8c99c0c-101b-43db-90ff-cecfa6e8598a) <br>
-> 이렇게 구조분해 할당으로도!! <br>
![image](https://github.com/An-jisu/Algorithm/assets/70849122/bd64930a-e1c0-4a77-b401-777a08dcc48e) <br>
-> n으로 나눈 값을 반복적으로 계속 더해주니까, reduce함수를 활용하여 반복을 처리해준다. <br> <br>

## ✔️ What I learned: <br>
- map: 모든 요소에 같은 행동을 반복해주는것/ reduce: 모든 요소에 같은 행동을 반복한 후, 그 값을 누적시켜주는 것!
